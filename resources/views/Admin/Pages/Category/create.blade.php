      ...
      <div class="container-fluid">
         ...
         <div class="card card-default" id="banner">
            ...
            <div class="card-body">
               <div class="row">
                  <div class="col-md-12">
                     <form method="POST" id="signup-form"  action="/admin/category/create">
                        @csrf
                        ...
                        <div id="corporate">
                           <div class="form-group">
                                 <input type="text" class="form-control" name="name"  placeholder="Category Name" autocomplete="name" autofocus >
                                 @error('name')
