   ...
   <section class="content" >
      <div class="container-fluid">
         ...
         <div class="card card-default">
            ...
            <!-- /.card-header -->
            <form action="/admin/course-update/{{$course->id}}" method="post" enctype="multipart/form-data">
            @csrf
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="" name="course_title" value="{{$course->course_title}}" placeholder="{{$course->course_title}}">
                     </div>
                     @error('course_title')
                     ...
                     <div id="hide">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" value="{{$course->course_url}}" name="course_url" placeholder="{{$course->course_url}}">
