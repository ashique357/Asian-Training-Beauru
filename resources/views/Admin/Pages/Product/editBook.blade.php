               ...
               <div class="row">
                  <div class="col-md-12">
                     <form method="POST" id="signup-form"  action="/admin/resource/edit/{{$product->id}}" enctype="multipart/form-data">
                        @csrf
                        <h2 class="form-title pb-20">Edit Book</h2>
                        <div class="form-group">
                           <input type="hidden" value="{{$product->product_type}}" name="product_type">
                        </div>
                        <div id="individual">
                           <div class="form-group">
                              <input type="text" class="form-control" name="name" value="{{$product->name}}"  placeholder="{{$product->name}}" autocomplete="name" autofocus >
                              @error('name')
                           ...
                           <div class="form-group">
                              <input type="text" class="form-control" name="author_name" value="{{$product->author_name}}" placeholder="{{$product->author_name}}" autocomplete="author_name" autofocus >
                              @error('author_name')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
                           ...
                           <div class="form-group">
                              <input type="text" class="form-control" name="publication" value="{{$product->publication}}" placeholder="{{$product->publication}}" autocomplete="publication" autofocus >
                              @error('publication')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
                           ...
                           <div class="form-group">
                              <input type="text" class="form-control" name="issn" value="{{$product->issn}}" placeholder="{{$product->issn}}" autocomplete="issn" autofocus >
                              @error('issn')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
                           ...
                           <div class="form-group">
                           <textarea class="form-control summernote" name="content" value="{{$product->content}}">{!!$product->content!!}</textarea>
                              @error('content')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                              </span>
