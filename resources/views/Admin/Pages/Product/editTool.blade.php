               ...
               <div class="row">
                  <div class="col-md-12">
                     <form method="POST" id="signup-form"  action="/admin/resource/edit/{{$product->id}}" enctype="multipart/form-data">
                        @csrf
                        <h2 class="form-title pb-20">Edit Tool</h2>
                        ...
                        <div id="corporate">
                           <div class="form-group">
                              ...
                              <div class="form-group">
                              <textarea class="form-control summernote" name="tools_details" value="{{$product->tools_details}}">{{$product->tools_details}}</textarea>
                           ...
                           <label for="">Upload Cover Image</label>
                              ...
                              <div class="form-group">
                                 <input type="text" class="form-control" name="price_user"  placeholder="{{$product->price_user}}" value="{{$product->price_user}}" autocomplete="issn" autofocus >
                                 @error('price_user')
                                 <span class="invalid-feedback" role="alert">
                                 <strong>{{ $message }}</strong>
                                 </span>
                              ...
                              <div class="form-group">
                                 <input type="text" class="form-control" name="price_member"  placeholder="{{$product->price_member}}" value="{{$product->price_member}}" autocomplete="price_member" autofocus >
                                 @error('price_member')
                                 <span class="invalid-feedback" role="alert">
                                 <strong>{{ $message }}</strong>
                                 </span>
