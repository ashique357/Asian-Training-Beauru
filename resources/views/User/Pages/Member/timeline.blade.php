...
<section id="teachers-singel" class="pt-70 pb-120 gray-bg">
   <div class="container-fluid gedf-wrapper">
      <div class="row justify-content-center">
         @include('User.Pages.Member.dashboard')
         <div class="col-lg-8 gedf-main">
            <div class="card gedf-card mt-50">
               ...
               <form action="/member/timeline" method="post">
                  @csrf
                  <div class="card-body">
            ...
            <div class="card gedf-card">
               <div class="card-header">
                  <div class="d-flex justify-content-between align-items-center">
                     <div class="d-flex justify-content-between align-items-center">
                        <div class="mr-2">
                           <img class="rounded-circle" width="45" src="/member/{{$post->member->photo}}" alt="">
                        </div>
                        <div class="ml-2">
                           <div class="h5 m-0">{{$post->member->name}}</div>
                        </div>
                     </div>
                     <div>
                     </div>
               ...
               <div class="card-footer">
                  <div class="dropdown">
                     ...
                     <div class="dropdown-menu comment-menu" data-display="static" aria-labelledby="dropdownMenuButton" style="width:100%; padding:10px">
                        @include('User.Pages.Member.commentsDisplay', ['comments' => $post->comments, 'post_id' => $post->id])
                        <form method="post" action="/member/timeline-comment">
                           @csrf
                           
                           <input type="hidden" name="post_id" value="{{ $post->id }}" />
                           <div class="form-group">
                              <label class="sr-only" for="message">post</label>
                              <textarea class="form-control" name="body" id="message" rows="3" placeholder="Leave a reply"></textarea>
                           </div>
                           <div class="card-footer">
               ...
               <form method="post" action="/member/timeline-comment">
                  ...
                  <div class="form-group">
                     <label class="sr-only" for="message">post</label>
                     <textarea class="form-control" name="body" id="message" rows="3" placeholder="Leave a comment"></textarea>
                  </div>
