        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="wm-breadcrumb">
                      <ul>
                           <li><a href="/">Home</a></li>
                           <li><a href="/member/training-provider/registration">Training Provider Registration</a></li>
                      </ul>
                </div>      
            </div>
        </div>
   ...
   <div class="wm-form-wrap wm-typography-element">
      <div class="row">
         <div class="col-md-8">
            @include('flash')
            <div class="card-body">
               <form method="POST" action="/member/training-provider/registration" >
                  @csrf
                  <div class="form-group row">
                     <label for="name" class="col-md-4 label-form text-md-right">{{ __('Training Provider Name') }}<span class="required">(*)</span></label>
                     <div class="col-md-8">
                 ...
                 <div class="form-group row">
                    <label for="web address" class="col-md-4 label-form text-md-right">{{ __('Website Address') }}</label>
                    <div class="col-md-8">
                       <input id="web" rows="4" cols="50" class="form-control form-class" name="web" value="{{ old('web') }}" >
                       @error('web')
                       <span class="invalid-feedback" role="alert">
                       <strong>{{ $message}}</strong>
                       </span>
                 ...
                 <div class="form-group row">
                    <label for="address" class="col-md-4 label-form text-md-right">{{ __('Years Of Establishment ') }}<span class="required">(*)</span></label>
                    <div class="col-md-8">
                       <input id="exp" type="text" class="form-control form-class" name="exp" value="{{ old('exp') }}" required autocomplete="exp" autofocus>
                       @error('exp')
                       <span class="invalid-feedback" role="alert">
                       <strong>{{ $message}}</strong>
                       </span>
                 ...
                 <div class="form-group row">
                    <label for="msg" class="col-md-4 label-form text-md-right">{{ __('About Provider') }}</label>
                    <div class="col-md-8">
